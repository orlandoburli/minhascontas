	...
	function exibirEmpresa() {
		...
		$.ajax({
			...
			success : function(data) {
				...
				fillSelect("#Empresa", retorno, "CodigoEmpresa",
						"RazaoSocialEmpresa", "");
	...
	function exibirLoja() {
		...
		$.ajax({
			...
			success : function(data) {
				...
				fillSelect("#Loja", retorno, "CodigoEmpresa;CodigoLoja;",
						"NomeLoja", "");
